...
export const statusMap = {
  full: {
    label: dictionary.common.status.full,
    class: "bg-gray-500 text-gray-800 border border-gray-300",
  },
  pending: {
    label: dictionary.common.status.pending,
    class: "bg-yellow-500 cursor-not-allowed opacity-80",
  },
  confirmed: {
    label: dictionary.common.status.confirmed,
    class: "bg-green-500 cursor-not-allowed opacity-80",
  },
  cancelled: {
    label: dictionary.common.status.cancelled,
    class: "bg-gray-500 text-gray-800 border border-gray-300",
  },
  cancel_request: {
